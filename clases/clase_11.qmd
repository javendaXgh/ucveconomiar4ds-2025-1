---
subtitle: "Clase 11: Gráficos Exploratorios (GE)"
date: "2025/04/30"
format:
  revealjs:
    incremental: true
...
## Conjuntos de Datos a Usar 1 {.large_code}
...
## Conjuntos de Datos a Usar 2 {.large_code}
...
## Conjuntos de Datos a Usar 3 {.large_code}
...
## Conjuntos de Datos a Usar 4 {.large_code}
...
```{r}
head(gapminder_2007_afeu)
```

## Tablas Sumario {.large_code}
...
boxplot(lifeExp ~ continent, 
        ...
        col = "#fb8b24",
        xlab='Continente',
        ylab='Expectativa de Vida por Continente-2007')

```
:::
:::::

## Diagrama de Caja - Concepto {.large_code}
...
boxplot(lifeExp ~ continent, 
        ...
        col = "#fb8b24",
        xlab='Continente',
        ylab='Expectativa de Vida- Gapminder')
...
-   Detectar diferencias significativas entre grupos.
    ...
    boxplot(lifeExp ~ continent, 
            ...
            col = "#fb8b24",
            xlab='Continente',
            ylab='Expectativa de Vida: año 2007 - Africa y Europa')
    ```
...
```{r}
#| echo: true
hist(main = 'Hist PIBpercap 2007',
     gapminder_2007$gdpPercap,
     col = "orange",
     xlab='PIB per Cápita',
     breaks = 50)

abline(v = median(gapminder_2007$gdpPercap), 
       col = "red",
       lwd = 2)
...
## Histogramas- Concepto {.large_code}
...
## Múltiples Histogramas {.large_code}
...
## Diagrama de Barras (Barplot) {.large_code}
...
## Diagrama de Dispersión (Scatter Plot) {.large_code}
...
## Diagrama de Dispersión- Concepto {.large_code}
...
## Diagrama de Dispersión- Casos de uso {.large_code}
...
## Ejemplo de Construcción de Gráfico en Base {.large_code}
